...
get_weather_forecaset_by_cities <- function(city_names){
  ...
  for (city_name in city_names){
    ...
    api_key <- "786492856e74afacdd517464a9bae978"
...
predict_bike_demand <- function(TEMPERATURE, HUMIDITY, WIND_SPEED, VISIBILITY, SEASONS, HOURS){
  model <- load_saved_model("D:\\data analysis\\data Viz with r\\r-capstone project\\BIKE SHARING DEMAND PREDICTION APP WITH SHINY AND LEAFLET\\model.csv")
  #D:\data analysis\data Viz with r\r-capstone project\BIKE SHARING DEMAND PREDICTION APP WITH SHINY AND LEAFLET\
...
generate_city_weather_bike_data <- function (){
  cities_df <- read_csv("D:\\data analysis\\data Viz with r\\r-capstone project\\BIKE SHARING DEMAND PREDICTION APP WITH SHINY AND LEAFLET\\selected_cities.csv")
  #"D:\data analysis\data Viz with r\r-capstone project\BIKE SHARING DEMAND PREDICTION APP WITH SHINY AND LEAFLET\selected_cities.csv"
